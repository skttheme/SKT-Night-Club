...
<?php esc_html_e( 'Skip to content', 'skt-night-club' ); ?>
</a>
<?php
...
<div class="header <?php if( !is_home() && is_front_page() && $header_trans == '') {echo esc_html('transheader');}?>">	
	<div class="container">
    <div class="logo">
		<?php skt_night_club_the_custom_logo(); ?>
        <div class="clear"></div>
		<?php	
        ...
        <div id="navigation" <?php if( $hideheaderbutton !== '') { ?>class="leftnavig"<?php } ?>><nav id="site-navigation" class="main-navigation">
